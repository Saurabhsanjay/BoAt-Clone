...
const Footer = () => {
   return (
      <div className="footer">
         <div className="flex firstFooterDiv" style={{display :"flex"}}>
            <div className="sendEmailBox">
               ...
               <div className="footerInputDiv flex"  style={{display :"flex"}}>
                  <input
                     type="text"
               ...
               <div className="mediaLinks flex"  style={{display :"flex"}}>
                  <FaFacebookF />
                  <FaTwitter />
                  <FaInstagram />
                  <FaYoutube />
            ...
            <div className="footerLinks flex"  style={{display :"flex"}}>
         ...
         <div className="midFooter flex"  style={{display :"flex"}}>
            ...
            <div className="flex linksToStores"  style={{display :"flex"}}>
